...
namespace PorkShopPOS
{
    class DatabaseCreation
    {
        ...
        * Date: 2017-01-20
        * Time: 2:45 PM
        * Purpose: method that sets up the database for this application
        *        
        */
        ...
        try
            {
                ...
                query = "drop database IF EXISTS pork_shop; "
                    ...
                    + " USE `pork_shop`; "
                    + "  grant create, select, insert, update, delete on pork_shop.* to 'pork_shop_admin'@'localhost' identified by '5tr&ng3rTh!ng$'; "
                    + " flush privileges;";
         ...
         * Date: 2017-01-20
         * Time: 2:45 PM
         * Purpose: method that sets up the tables and adds data to them, called in the Welcome page
         *        
         */
        public void createDatabaseTables() {
         try
         {
            createDatabase();
            MySqlConnection conn;
            string connectionStr = "server=localhost; database=pork_shop; user=pork_shop_admin; password=5tr&ng3rTh!ng$;";
            conn = new MySqlConnection(connectionStr);
            MySqlCommand cmd;
      
            conn.Open();

            string query = " CREATE TABLE `bar` ( "
       ...
       + "         )ENGINE=InnoDB DEFAULT CHARSET=latin1;"
        ...
        + "      ) ENGINE=InnoDB DEFAULT CHARSET=latin1;"
          ...
          + "    (NULL, 'Alabama Slammer', 'Cocktail', 7.5, 100);"
           ...
           + "   INSERT into `userAccess` VALUES(1, 'M00001', 'boss', '3'), (2, 'B00002', 'pass', '2'), (3, 'W00003', 'word', '1');"
          ...
          + "    Values(1, 'M00001', '2017-01-01', '2017-01-27', 20.00),"
           ...
           + " INSERT into employee VALUES ('B00002', 'Bryan', 'MacFarlane', '222 Street', 'Bedeque', 'PE', 'c1n3d2', '9024445555', '111222333', '2017-01-01', 'Active', '0000-00-00', 'Bartender'),"
